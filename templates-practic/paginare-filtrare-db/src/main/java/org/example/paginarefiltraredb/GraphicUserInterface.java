...
public class GraphicUserInterface extends Application implements ViewLoader{
    ...
    public void init() throws Exception {
        ...
        clientService = new ClientService(clientRepo, clientValidator);
        managerService = new ManagerService(managerRepo, managerValidator);
        staffService = new StaffService(staffRepo, staffValidator);
        vipClientService = new VipClientService(vipClientRepo, vipClientValidator);
    }
    ...
    public void stop() throws Exception {
        ...
        // Close the static global connection
